...
class FloatConverter(BaseFieldConverter):
    def __init__(self, name):
        super(FloatConverter, self).__init__(name)
...
class StringConverter(BaseFieldConverter):
    def __init__(self, name):
        super(StringConverter, self).__init__(name)
...
class DatetimeConverter(BaseFieldConverter):
    def __init__(self, name):
        super(DatetimeConverter, self).__init__(name)
